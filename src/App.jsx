...
function ActivityBlocks({ rows }){
  ...
  rows.forEach(t=>{
    const rndH=(Math.random()*24)|0  // proxy heure
  ...
  return (
    <div className="grid-3">
      ...
      <div className="card">
        <div className="kpi-title">Activité par Jour (Lun→Dim)</div>
        {bar(dow.map((x,i)=>({...x,d:dowLabel[i]})),'d')}
      </div>
      <div className="card">
        <div className="kpi-title">Activité par Mois</div>
...
function EquityBlock({ rows, cashflows, initial, convert, ccy }) {
  ...
  return (
    <div className="card">
      <div className="block-head" style={{display:'flex',justifyContent:'space-between',flexWrap:'wrap',gap:8}}>
        <div className="block-title cap">Courbe d’Équité</div>
        <div className="block-tools" style={{display:'flex',alignItems:'center',gap:8}}>
...
export default function App(){
  ...
  // --- Trades (démo + imports utilisateur) ---
  ...
  // --- Sous-titre editable (sous le brand) ---
        ...
        <>
          ...
          {view === 'control' && (
            <div className="control-page">
              ...
              {/* Bandeau haut */}
              <div className="card">
                <div className="block-head" style={{display:'flex',justifyContent:'space-between',flexWrap:'wrap',gap:16}}>
                  <div>
                    <h1 className="brand" style={{fontSize:28, margin:0, color:'var(--white)'}}>{t.brand}</h1>
                    {!editSub ? (
                      <p className="subtitle cap" style={{marginTop:6, color:'var(--text)'}}>
                        {subtitle}
                        <button
                  ...
                  <div className="block-tools" style={{flexWrap:'wrap', justifyContent:'flex-end', display:'flex', gap:8}}>
              ...
              <div className="control-section control-grid">
                ...
                <div className="col-4">
                  <div className="grid-2">
                    <div className="card">
                      <div className="kpi-title cap">Taux de Réussite</div>
                      <WinRateBlock rows={filtered}/>
                    </div>

                    <div className="card">
                      <div className="kpi-title cap">Ratios (Pro)</div>
              ...
              <div className="control-section control-grid">
                <div className="col-6">
                  <div className="card">
                    <div className="kpi-title cap">Corrélation Entre Stratégies</div>
                    <CorrelationBlock rows={filtered} convert={convert} ccy={displayCcy}/>
                  </div>
                </div>
                <div className="col-6">
                  <div className="card">
                    <div className="kpi-title cap">Mapping Stratégie × Broker</div>
              ...
              {/* Calendrier mensuel */}
              <div className="control-section">
                <div className="kpi-title cap" style={{marginBottom:8}}>Calendrier Mensuel</div>
                <CalendarMonthly
                  rows={filtered}
                  convert={convert}
                  ccy={displayCcy}
              ...
              <div className="control-section">
                <div className="card">
                  <div className="kpi-title cap">Activité</div>
