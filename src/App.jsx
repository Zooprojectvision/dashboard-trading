...
import LogoZPV from './LogoZPV.jsx' // ← (1) AJOUT ICI
      ...
      <ResponsiveContainer width="100%" height="86%">
        {mode === 'global' ? (
          <ComposedChart data={globalSeries} margin={{ left: 8, right: 8, top: 8, bottom: 8 }}>
            ...
            <Tooltip />
            <Legend />
            <Line type="monotone" dataKey="equity" name="Équité" dot={false} stroke={C.white} strokeWidth={1.8} />
...
export default function App(){
  ...
  // === RENDER ===
  return (
    // (2) WRAPPER de test — tu peux le retirer après validation visuelle
    <div style={{border:'2px solid #444', padding:16, color:'#c5ccd3'}}>
      <div style={{marginBottom:8}}>App monte ✅</div>
